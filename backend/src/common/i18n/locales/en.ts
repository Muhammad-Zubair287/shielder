export const en: Record<string, string> = {
  ...
  'validation.shippingAddressMin': 'Address must be at least {{limit}} characters.',
  ...
  'profile.noFieldsToUpdate':   'No fields provided to update.',
  'profile.imageDataUriRejected': 'Profile image must be a URL/path, not base64 image data.',
  'profile.imageInvalidPath':   'Profile image must be a valid URL or uploads/profile path.',
  ...
  'contact.captchaRequired': 'Please confirm you are not a robot.',
  'contact.captchaFailed': 'CAPTCHA verification failed.',

  // ── Storage / Uploads ────────────────────────────────────────────────────
  'storage.imageEmptyOrUnreadable': 'Uploaded image is empty or unreadable.',
  'storage.imageTooLarge': 'Image is too large.',
  'storage.imageInvalidType': 'Invalid image file type.',
  'storage.imageInvalidMagicBytes': 'Invalid or corrupted image file.',
  'storage.imageTypeMismatch': 'Uploaded file content does not match its image type.',
  'storage.uploadFailed': 'File upload failed.',
  'storage.deleteFailed': 'File deletion failed.',
  'storage.unauthorizedPrivateFile': 'You are not authorized to access this file.',
  'storage.privateExpired': 'This file link has expired.',
  'storage.privateInvalidToken': 'Invalid or expired file token.',
  'storage.privateInvalidRef': 'Invalid file reference.',
  'storage.fileNotFound': 'Requested file not found.',
  'storage.privateUnsupported': 'Private file access is not supported.',
  'storage.attachmentTooLarge': 'Attachment is too large.',
  'storage.attachmentInvalidType': 'Attachment type is not supported.',
  ...
  'payment.verificationFailed': 'Payment verification failed. Please try again.',
  'payment.gatewayUnavailable': 'Unable to process your payment. Please try again.',
  'payment.gatewayTimeout': 'Payment timed out. Please try again.',
  'payment.insufficientStockAfterPayment': 'Payment was received but the item is no longer in stock. A refund has been initiated.',
  'payment.refundRequired': 'A refund is required for this payment.',
  'payment.refundFailed': 'Refund could not be processed. Please contact support.',
  'payment.mockNotAvailable': 'Mock payment mode is not available.',
  'payment.sessionNotFound': 'Payment session not found or expired.',
  'payment.sessionForbidden': 'You do not have access to this payment session.',
  'payment.sessionExpired': 'Payment session has expired.',
  'payment.invalidMockScenario': 'Invalid mock payment scenario.',
  'payment.invalidCallback': 'Invalid payment callback.',
  'payment.sessionAlreadyCompleted': 'This payment session has already been completed.',
  'payment.amountInvalid': 'Amount must be a valid number.',
  'payment.amountNotNumber': 'Amount is not a valid number.',
  'payment.amountNotFinite': 'Amount must be a finite number.',
  'payment.amountMustBePositive': 'Amount must be greater than zero.',
  'payment.orderIdInvalid': 'Order ID must be a valid UUID.',
  'payment.orderNotFound': 'Order not found.',
  'payment.alreadyRecorded': 'Payment already recorded for this order.',
  'payment.transactionIdExists': 'Transaction ID already exists.',
  'payment.alreadyRefunded': 'Payment is already refunded.',
  'payment.gatewayRefundFailed': 'Payment gateway refund failed. Local refund was not applied.',
  'payment.exceedsRemaining': 'Payment amount exceeds the remaining order balance.',
  'payment.invalidMethod': 'Invalid payment method.',
  'payment.orderNotPayable': 'This order cannot accept payments in its current state.',
  'payment.orderInvalidTotal': 'Order has an invalid total amount.',
