export const ar: Record<string, string> = {
  ...
  'validation.shippingAddressMin': 'يجب أن يكون العنوان {{limit}} أحرف على الأقل.',
  ...
  'profile.noFieldsToUpdate':   'لم يتم تقديم أي حقول للتحديث.',
  'profile.imageDataUriRejected': 'يجب أن تكون صورة الملف الشخصي رابطًا/مسارًا وليست بيانات base64.',
  'profile.imageInvalidPath':   'يجب أن تكون صورة الملف الشخصي رابطًا صالحًا أو مسار uploads/profile.',
  ...
  'contact.captchaRequired': 'يرجى تأكيد أنك لست روبوتًا.',
  'contact.captchaFailed': 'فشل التحقق من الكابتشا.',

  // ── Storage / Uploads ────────────────────────────────────────────────────
  'storage.imageEmptyOrUnreadable': 'الصورة المرفوعة فارغة أو غير قابلة للقراءة.',
  'storage.imageTooLarge': 'الصورة كبيرة جدًا.',
  'storage.imageInvalidType': 'نوع ملف الصورة غير صالح.',
  'storage.imageInvalidMagicBytes': 'ملف الصورة غير صالح أو تالف.',
  'storage.imageTypeMismatch': 'لا يتطابق محتوى الملف مع نوع الصورة.',
  'storage.uploadFailed': 'فشل رفع الملف.',
  'storage.deleteFailed': 'فشل حذف الملف.',
  'storage.unauthorizedPrivateFile': 'غير مصرح لك بالوصول إلى هذا الملف.',
  'storage.privateExpired': 'انتهت صلاحية رابط هذا الملف.',
  'storage.privateInvalidToken': 'رمز الملف غير صالح أو منتهي.',
  'storage.privateInvalidRef': 'مرجع الملف غير صالح.',
  'storage.fileNotFound': 'تعذر العثور على الملف المطلوب.',
  'storage.privateUnsupported': 'تعذر الوصول للملف الخاص.',
  'storage.attachmentTooLarge': 'المرفق كبير جدًا.',
  'storage.attachmentInvalidType': 'نوع المرفق غير مدعوم.',
  ...
  'payment.failed': 'لم يكتمل الدفع. يرجى المحاولة مرة أخرى.',
  'payment.cancelled': 'تم إلغاء الدفع.',
  'payment.pending': 'الدفع لا يزال قيد الانتظار.',
  'payment.verificationFailed': 'فشل التحقق من الدفع. يرجى المحاولة مرة أخرى.',
  'payment.gatewayUnavailable': 'تعذر معالجة الدفع. يرجى المحاولة مرة أخرى.',
  'payment.gatewayTimeout': 'انتهت مهلة الدفع. يرجى المحاولة مرة أخرى.',
  'payment.insufficientStockAfterPayment': 'تم استلام الدفع ولكن المنتج لم يعد متوفراً. تم بدء عملية الاسترداد.',
  'payment.refundRequired': 'يلزم استرداد هذا الدفع.',
  'payment.refundFailed': 'تعذر معالجة الاسترداد. يرجى التواصل مع الدعم.',
  'payment.mockNotAvailable': 'وضع الدفع التجريبي غير متاح.',
  'payment.sessionNotFound': 'جلسة الدفع غير موجودة أو منتهية.',
  'payment.sessionForbidden': 'ليس لديك صلاحية الوصول إلى جلسة الدفع هذه.',
  'payment.sessionExpired': 'انتهت صلاحية جلسة الدفع.',
  'payment.invalidMockScenario': 'سيناريو الدفع التجريبي غير صالح.',
  'payment.invalidCallback': 'استدعاء الدفع غير صالح.',
  'payment.sessionAlreadyCompleted': 'تم إكمال جلسة الدفع هذه مسبقاً.',
  'payment.amountInvalid': 'يجب أن يكون المبلغ رقماً صالحاً.',
  'payment.amountNotNumber': 'المبلغ ليس رقماً صالحاً.',
  'payment.amountNotFinite': 'يجب أن يكون المبلغ رقماً محدوداً.',
  'payment.amountMustBePositive': 'يجب أن يكون المبلغ أكبر من صفر.',
  'payment.orderIdInvalid': 'يجب أن يكون معرّف الطلب بصيغة UUID صالحة.',
  'payment.orderNotFound': 'الطلب غير موجود.',
  'payment.alreadyRecorded': 'تم تسجيل الدفع لهذا الطلب مسبقاً.',
  'payment.transactionIdExists': 'معرّف المعاملة موجود مسبقاً.',
  'payment.alreadyRefunded': 'تم استرداد هذا الدفع مسبقاً.',
  'payment.gatewayRefundFailed': 'فشل استرداد الدفع عبر بوابة الدفع. لم يتم تطبيق الاسترداد محلياً.',
  'payment.exceedsRemaining': 'مبلغ الدفع يتجاوز الرصيد المتبقي للطلب.',
  'payment.invalidMethod': 'طريقة الدفع غير صالحة.',
  'payment.orderNotPayable': 'لا يمكن قبول الدفعات لهذا الطلب في حالته الحالية.',
  'payment.orderInvalidTotal': 'إجمالي الطلب غير صالح.',
