    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-2">{t('auth.checkEmail')}</h2>
          <p className="text-slate-600 mb-6">
            {t('auth.resetLinkSent')} <span className="font-semibold">{email}</span>
          </p>
          <Link
            href="/login"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">{t('auth.forgotPassword')}</h1>
        <p className="text-slate-600 mb-6">{t('auth.enterEmailToReset')}</p>
