...
export default function TrustSection() {
  ...
  return (
    <ScrollReveal className="py-20 bg-[#F8FAFC]" delayMs={30} threshold={0.16} durationMs={1000} effect="fade-up">
      <section dir={isRTL ? 'rtl' : 'ltr'}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-14 items-start">

          {/* Image */}
          <div className={`relative ${isRTL ? 'lg:order-last' : ''}`} data-aos={isRTL ? 'fade-left' : 'fade-right'} data-aos-delay="160" data-aos-duration="1100">
